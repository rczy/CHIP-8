...
cl $SOURCE_FILES_PATH /Fe"$OUTPUT_DIR\$EXECUTABLE" /Fo"$OUTPUT_DIR"\ /I $INC_PATH /link /LIBPATH:$LIB_PATH SDL2.lib SDL2main.lib shell32.lib /SUBSYSTEM:CONSOLE /DEBUG:FULL
